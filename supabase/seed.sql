...
insert into members (id, name, avatar, color, is_approver) values
  ('00000000-0000-4000-8000-000000000001', 'Dad',    '🤴', '#3E6C9E', true),
  ('00000000-0000-4000-8000-000000000002', 'Rach',   '👸', '#C74A34', true),
  ...
  ('00000000-0000-4000-8000-000000000006', 'Dale',   '🏄‍♂️', '#588B4C', false);
